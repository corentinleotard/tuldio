...
- **Root-cause first** — when fixing a bug, diagnose the root cause before proposing a fix. Don't patch symptoms. If the cause isn't clear, ask questions first — don't guess.
