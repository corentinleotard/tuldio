...
export const lineSchema = z.object({
  ...
  unitPrice: z.number().int().min(0).max(100_000_000).describe('Unit price excl. tax in euro cents (e.g. 4500 = 45.00€, 132000 = 1320.00€). Always multiply the euro amount by 100.'),
