    ...
    <Document>
      <Page size="A4" style={s.page}>
        ...
        <View style={s.header}>
          ...
          <View>
            <Text style={s.documentTitle}>FACTURE</Text>
        ...
        <Text style={s.date}>
          ...
          {props.dueDate && `  |  Echéance: ${formatDate(props.dueDate)}`}
        </Text>
        ...
        <Text style={s.legal}>
          ...
          d'intérêt légal sera appliquée. Indemnité forfaitaire de recouvrement:
          40€.
        </Text>
      </Page>
    </Document>
