...
export const SYSTEM_FIELDS: SystemFieldDef[] = [
  ...
  { key: 'payment_terms', label: 'Conditions de paiement', zone: 'payment', scope: 'quote', showQuote: true, showInvoice: false, sortOrder: 0, defaultValue: 'Paiement a reception de facture' },
